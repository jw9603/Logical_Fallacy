...
def main():
    ...
    # 파일에 출력할 객체 생성
    with open('./result/roberta/CLIMATE/Roberta_query_specific_no_train_binary_result_1time_9class.txt','w') as output_file:
        ...
        save_results_to_pickle(confidence_scores_0,labels_0,predicted_labels_0,'./result/roberta/CLIMATE/new_data/score_orig.pkl')
        ...
        save_results_to_pickle(confidence_scores_7,labels_7,predicted_labels_7,'./result/roberta/CLIMATE/new_data/score_cg.pkl')
        ...
        save_results_to_pickle(confidence_scores_8,labels_8,predicted_labels_8,'./result/roberta/CLIMATE/new_data/score_ex.pkl')
        ...
        save_results_to_pickle(confidence_scores_9,labels_9,predicted_labels_9,'./result/roberta/CLIMATE/new_data/score_go.pkl')

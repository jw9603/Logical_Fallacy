...
if __name__ =='__main__':
    ...
    data_path = './new_data/COVID-19/covid_all.json'
    import torch
    torch.set_printoptions(threshold=1000000000000000000)
    
    with open('./result/roberta/CLIMATE/Roberta_query_specific_v2_test_dev_train_result_1time_5class.txt','w') as output_file:
    # with open('./result/roberta/COVID/Roberta_query_specific_result_1time_5class.txt','w') as output_file:
        ...
        with open('./result/COVID-19/data/confidence_scores1.pkl', 'wb') as f:
            pickle.dump(confidence_scores, f)

        with open('./result/COVID-19/data/test_labels1.pkl', 'wb') as f:
            pickle.dump(test_labels, f)

        with open('./result/COVID-19/data/predicted_labels1.pkl', 'wb') as f:
        ...
        print('Micro F1 score in TEST:', mf1_test)
        with open('./result/COVID-19/data/confidence_score_cg1.pkl', 'wb') as f:
            pickle.dump(confidence_scores, f)

        with open('./result/COVID-19/data/test_labels_cg1.pkl', 'wb') as f:
            pickle.dump(test_labels, f)

        with open('./result/COVID-19/data/predicted_labels_cg1.pkl', 'wb') as f:
            pickle.dump(predicted_labels, f)
        # assert -1 == 0
        ...
        with open('./result/COVID-19/data/confidence_score_ex1.pkl', 'wb') as f:
            pickle.dump(confidence_scores, f)

        with open('./result/COVID-19/data/test_labels_ex1.pkl', 'wb') as f:
            pickle.dump(test_labels, f)

        with open('./result/COVID-19/data/predicted_labels_ex1.pkl', 'wb') as f:
            pickle.dump(predicted_labels, f)
        # assert -1 == 0
        print('===============================================================================`==================')
        ###################################### GO dataset ########################################
        ...
        with open('./result/COVID-19/data/confidence_score_go1.pkl', 'wb') as f:
            pickle.dump(confidence_scores, f)

        with open('./result/COVID-19/data/test_labels_go1.pkl', 'wb') as f:
            pickle.dump(test_labels, f)

        with open('./result/COVID-19/data/predicted_labels_go1.pkl', 'wb') as f:
            pickle.dump(predicted_labels, f)
        # assert -1 == 0
        print('=================================================================================================')

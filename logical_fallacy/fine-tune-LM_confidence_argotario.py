...
if __name__ =='__main__':
    ...
    with open('./result/roberta/Argotario/Roberta_query_specific_v2_test_dev_train_result_1time_5class.txt','w') as output_file:
        import sys
        ...
        with open('./result/roberta/Argotario/data/confidence_scores.pkl', 'wb') as f:
            pickle.dump(confidence_scores, f)

        with open('./result/roberta/Argotario/data/test_labels.pkl', 'wb') as f:
            pickle.dump(test_labels, f)

        with open('./result/roberta/Argotario/data/predicted_labels.pkl', 'wb') as f:
        ...
        print('Micro F1 score in TEST:', mf1_test)
         # confidence_scores, test_labels, predicted_labels를 pickle 파일에 저장
        # confidence_scores, test_labels, predicted_labels를 pickle 파일에 저장
        with open('./result/roberta/Argotario/data/confidence_score_cg.pkl', 'wb') as f:
            pickle.dump(confidence_scores, f)

        with open('./result/roberta/Argotario/data/test_labels_cg.pkl', 'wb') as f:
            pickle.dump(test_labels, f)

        with open('./result/roberta/Argotario/data/predicted_labels_cg.pkl', 'wb') as f:
            pickle.dump(predicted_labels, f)
        # assert -1 == 0
        ...
        # confidence_scores, test_labels, predicted_labels를 pickle 파일에 저장
        with open('./result/roberta/Argotario/data/confidence_scores_ex.pkl', 'wb') as f:
            pickle.dump(confidence_scores, f)

        with open('./result/roberta/Argotario/data/test_labels_ex.pkl', 'wb') as f:
            pickle.dump(test_labels, f)

        with open('./result/roberta/Argotario/data/predicted_labels_ex.pkl', 'wb') as f:
            pickle.dump(predicted_labels, f)
        # assert -1 == 0
        print('===============================================================================`==================')
        ###################################### GO dataset ########################################
        ...
        # confidence_scores, test_labels, predicted_labels를 pickle 파일에 저장
        with open('./result/roberta/Argotario/data/confidence_scores_go.pkl', 'wb') as f:
            pickle.dump(confidence_scores, f)

        with open('./result/roberta/Argotario/data/test_labels_go.pkl', 'wb') as f:
            pickle.dump(test_labels, f)

        with open('./result/roberta/Argotario/data/predicted_labels_go.pkl', 'wb') as f:
            pickle.dump(predicted_labels, f)
        # assert -1 == 0
        print('=================================================================================================')

...
def load_and_tokenize_data(file_path, tokenizer, max_length):
    ...
    label_map = {
        ...
        "red herring":7,
        "intentional fallacy":8,
        "false dilemma":9,
        "irrelevant authority":10,
...
def main():
    ...
    # 데이터 로드 및 토큰화
    file_path = './new_data/LOGIC/LOGIC_train.json'
    max_length = 512  # 최대 길이 지정
    
    # 파일에 출력할 객체 생성
    with open('./result/roberta/LOGIC/Roberta_query_specific_no_train_v2_result_1time_5class.txt','w') as output_file:
        ...
        save_results_to_pickle(confidence_scores_0,labels_0,predicted_labels_0,'./result/roberta/LOGIC/new_data/score_orig.pkl')
        ...
        save_results_to_pickle(confidence_scores_7,labels_7,predicted_labels_7,'./result/roberta/LOGIC/new_data/score_cg.pkl')
        ...
        save_results_to_pickle(confidence_scores_8,labels_8,predicted_labels_8,'./result/roberta/LOGIC/new_data/score_ex.pkl')
        ...
        save_results_to_pickle(confidence_scores_9,labels_9,predicted_labels_9,'./result/roberta/LOGIC/new_data/score_go.pkl')

def get_model_output(inputs):
    # 모델 초기화
    # model = AutoModelForSequenceClassification.from_pretrained('roberta-base', num_labels=13)
    model = AutoModelForSequenceClassification.from_pretrained('microsoft/deberta-base',num_labels=13)
    # 모델 입력 준비

...
def tokenize_sequence(samples):
    ...
    return tknz(samples['text'],padding=True, truncation=True,max_length=128)
...
if __name__ =='__main__':
    ...
    with open('./result2/argotario/roberta_no_query_lr_1e5_ml_128_ep_20_bs_16_result_1time_5class.txt','w') as output_file:
        import sys
        ...
        # tknz, mdl = load_model_deberta()
        tknz, mdl = load_model()
        # tknz, mdl = load_model_electra()

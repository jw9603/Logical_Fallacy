...
@retry()
def binary_fallacy_classification_query_zero_list(text,text1,text2):
    mode = 'ZERO-SHOT'
    cmpl = client.chat.completions.create(
        # model='gpt-4',
        model='gpt-3.5-turbo-16k-0613',
...
if __name__ =='__main__':
    ...
    with open('./result/CLIMATE/binary/gpt-3.5-turbo_cg_go_query_result_seed0_1time.txt','w') as output_file:
    # with open('./result/CLIMATE/binary/gpt-4.0_explanation_query_result_seed0_1time_.txt','w') as output_file:
        import sys
        # 기존의 stdout을 백업합니다.
        ...
        for sample in json_data['test']:
            ...
            completion,mode = binary_fallacy_classification_query_zero_list(t1,t3,t5)

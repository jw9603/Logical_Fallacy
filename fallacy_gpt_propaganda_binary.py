...
if __name__ =='__main__':
    ...
    with open('./result/propaganda/binary/gpt-4_confidence_ranking_result_seed0_1time_.txt','w') as output_file:
        import sys
        # 기존의 stdout을 백업합니다.
...
=
    ...
    # with open('./new_data/propaganda/propaganda_test_with_no_fallacy2.json','w') as f:

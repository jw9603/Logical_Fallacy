...
if __name__ =='__main__':
    ...
    data_path = './data/logic/LOGIC_all.json' # Combine the training, validation, and test datasets.
    import torch
    torch.set_printoptions(threshold=1000000000000000000)
    
    with open('./result/logic/roberta_go_query_lr_1e5_ml_512_ep_40_bs_64_result_1time_13class.txt','w') as output_file:
        import sys
